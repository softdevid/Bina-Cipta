        ...
        <div class="bg-gray-800 pt-3">
            <div class=" bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                <div
                    ...
                    <h1 class="font-bold pl-2">Tambah Stok Gudang</h1>
                </div>
            </div>
        </div>
        <div class="container mx-auto my-4">
            <div class="flex flex-warp justify-center mx-4" data-aos="zoom-in" data-aos-duration="1000">
                <div
                    ...
                    <img class="object-cover w-full md:h-96rounded-t-lg h-auto  md:rounded-none"
                        src="{{$products->url}}">
                    <div class="flex flex-col justify-between p-4 leading-normal">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                            {{-- {{$hasil->judul_detail}} --}}
                        </h5>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Deskripsi :
                            {{$products->deskripsi}}</p>
                        <span class="mb-3 font-normal text-gray-700 dark:text-gray-400"></span>
                        <form action="{{route('admin-store.update', $products->id)}}" method="POST">
