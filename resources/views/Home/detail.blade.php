...
<div class="container mx-auto my-8">
    <div class="flex flex-warp justify-center mx-4">
        <div
            ...
            <img class="object-cover w-full md:h-96rounded-t-lg h-auto  md:rounded-none md:rounded-l-lg"
                src="{{$products->url}}" alt="{{$products->namagambar}}">
            <div class="flex flex-col justify-between p-4 leading-normal">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    {{$products->nama}}
                </h5>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Deskripsi : {{$products->deskripsi}}</p>
